...
if ($inputData !== null) {
    ...
    $queryNumero = "SELECT COALESCE(MAX(cat_producto_num) + 1, 1) AS nuevo_numero FROM cat_categoria_producto";
    ...
    $query = "INSERT INTO cat_categoria_producto (cat_producto_num, estado_id, cat_prod_nombre) VALUES (:numero, :estado, :nombre)";
