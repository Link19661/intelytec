...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="modal-body">
                        <form class="form-inline" id="formulario" method="post">
                            <div class="input-group input-group-sm">
                                <div class="col-auto">
                                    <label for="Nombre" class="form-check-label">Nombre Categoría</label>
        ...
        fetch('get/getCategoria.php')
            ...
            .then(data => {
                ...
                data.forEach(categoria => {
                    ...
                    row.insertCell().textContent = categoria.cat_producto_num;
    ...
    function registrarCategoria(event) {
        ...
        if (nombreCategoria == "" || estadoCategoria == "") {
            ...
            swal({
                    title: "¿Seguro que quieres registrar esta categoría?",
                    text: "Luego podrás editar la categoría!",
                    icon: "warning",
                    buttons: {
                        cancel: "Cancelar",
                        confirm: {
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        fetch('create/createCategoria.php', {
                                method: 'POST',
                                body: JSON.stringify({
                            ...
                            .then(data => {
                                ...
                                if (data.success) {
                                    Toast.fire({
                                        icon: 'success',
                                        title: 'Se ha registrado la categoría con éxito!'
                                    });
